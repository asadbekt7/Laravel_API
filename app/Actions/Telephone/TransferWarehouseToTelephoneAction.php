<?php
// App/Actions/Telephone/TransferWarehouseToTelephoneAction.php
namespace App\Actions\Telephone;
...
class TransferWarehouseToTelephoneAction
{
    ...
    public function execute(
        ...
        return DB::transaction(function () use ($warehouseIds, $inventoryNumber, $roomData): array {
            ...
            foreach ($warehouseItems as $item) {
                $telephones[] = Telephonemodel::create([
                    'name'                => $item->name,
