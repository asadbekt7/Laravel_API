...
class StoreMalumotRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'contract_file_path'     => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:10240'],

            // Yetkazuvchi
            'yetkazuvchi_id'         => ['required', 'integer', 'exists:yetkazuvchi,id'],

            // Bildirishnoma
            'bildirishnoma_number'   => ['required', 'string', 'max:255'],
            'bildirishnoma_date'     => ['required', 'date'],
            'bildirishnoma_file_path'=> ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:10240'],
            ...
            'ishonchnoma_file_path'  => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:10240'],

            // Hisob-faktura
            'hisob_faktura'          => ['required', 'string', 'max:255'],
            'hisob_faktura_date'     => ['required', 'date'],
            'hisob_faktura_file_path'=> ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:10240'],
    ...
    public function messages(): array
    {
        return [
            ...
            'contract_file_path.file'          => 'Kontrakt fayli to\'g\'ri yuklangan bo\'lishi kerak.',
